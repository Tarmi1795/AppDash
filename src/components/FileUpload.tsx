...
import { Upload, FileText, ArrowRight, PenLine } from 'lucide-react';
...
export const FileUpload: React.FC<FileUploadProps> = ({ onDataLoaded, onDirectEntry }) => {
        ...
        >
          ...
          <div className="pt-4 flex items-center gap-4">
            ...
            <button
              ...
              className="group flex items-center gap-4 px-6 py-3 bg-white/5 border border-white/10 rounded-lg hover:bg-white hover:text-obsidian transition-all duration-300"
            >
              <PenLine className="w-4 h-4 text-gray-400 group-hover:text-obsidian transition-colors" />
              <span className="text-[11px] font-mono font-bold uppercase tracking-[0.2em]">Direct Entry</span>
              <ArrowRight className="w-4 h-4 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
            </button>
          </div>
        </motion.div>
